...
namespace TodoApi.Controllers
{
    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        // GET: api/TodoItems
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TodoItemDTO>>> GetTodoItemDTOs()
        {
        ...
        {
            TodoItem item = new TodoItem { Name = todoItem.Name, IsComplete = todoItem.IsComplete, Secret = "No cargado" };
